...
public static void main ( String[] args ) {
	...
	InputStream IS = null;
	String FoundCodeName = null;
	String FoundBuild = null;
				...
				while ( ( Line = BR.readLine (  ) ) != null ) {
					...
					if ( Line.contains ( "Latest firmware" ) ) {
						...
						if ( Line.contains ( Device ) ) {
							...
							FoundCodeName = LineArray[0];
							FoundBuild = LineArray[1];
							FoundDevice = LineArray[2];
							FoundDevice = FoundDevice.replace ( "(", "" );
							FoundDevice = FoundDevice.replace ( ")", "" );


							write ( "\nCodename:	" + FoundCodeName + "\n", 15 );
							write ( "Build:		" + FoundBuild + "\n", 15 );
							write ( "Device:		" + FoundDevice + "\n\n", 15 );
