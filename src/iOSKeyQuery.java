...
class iOSKeyQuery {
	...
	public static void usage ( String Error, int Return ) {
		...
		write ( "--device/-D		The build string of the device (For example:  15A5368a, 14B72, 9B206, 15A372 etc) \n", 15 );
		write ( "--device/-D		The device type (For Example: iPhone6,1, iPad3,4, iPhone3,3, iPad4,4 etc)\n\n", 15 );
		write ( "EXAMPLE: java " + MainClass + " -V iPhone6,1 -B 15A5368a\n", 15 );
		write ( "EXAMPLE: java " + MainClass + " --device iPad3,4 --build 14B72\n", 15 );
		write ( "EXAMPLE: java " + MainClass + " -V iPhone3,3 --build 9B206\n", 15 );
